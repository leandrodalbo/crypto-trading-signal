...
public class BollingerBands {
    ...
    public BollingerBands(Core core) {
        this.core = core;
    }
    ...
    public Map<String, Double> bands(float[] values) {
        ...
        double[] upperBand = new double[values.length - period + 1];
        double[] middleBand = new double[values.length - period + 1];
        double[] lowerBand = new double[values.length - period + 1];
